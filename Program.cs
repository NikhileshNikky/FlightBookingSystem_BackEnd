...
builder.Services.AddDbContext<HawksAvaitionDBContext>(options =>
{
    options.UseSqlServer(
        connectionString: "server=DESKTOP-LT4QVVV\\SQLEXPRESS;database=HawksAviationDb;Trusted_Connection=True" //builder.Configuration["ConnectionString:HawksAviationDB"]
    ); 
});
